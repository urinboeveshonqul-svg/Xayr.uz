...
> **Branch:** main · **Latest at sync:** fixed the withdrawal display-rounding bug (`formatMoney` rounded net 9,600 → "10 ming"; now exact "9 600 so'm" on all creator financial surfaces) on top of the simplified withdrawal UX + net-display payout model (no migration) + Payme (Merchant API, #48 pending) + Click (SHOP API)
>
